...
<Sheet.Root {portal} bind:open={episodeListOpen}>
  ...
  <Sheet.Content class='w-full sm:w-[550px] p-3 sm:p-6 max-w-full sm:max-size-full overflow-y-scroll flex flex-col !pb-0 shrink-0 gap-0 bg-black justify-between overflow-x-clip'>
